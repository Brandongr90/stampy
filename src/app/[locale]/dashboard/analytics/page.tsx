            ...
            {[
              ...
              <div key={index} className="space-y-2">
                <div className="flex items-center justify-between">
                  <span className="font-medium text-almost-black">
                    {reward.name}
                  </span>
                  <span className="text-sm text-gray-500">
                    {t("redemptions", { count: reward.redeemed })}
                  </span>
                </div>
      ...
      <div className="bg-white rounded-3xl border border-gray-200 p-6 shadow-soft">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center p-4 bg-gray-50 rounded-2xl">
            ...
            <p className="text-sm text-gray-500">{t("customerRetention")}</p>
          </div>
          <div className="text-center p-4 bg-gray-50 rounded-2xl">
            <div className="flex items-center justify-center gap-2 mb-2">
              <TrendingUp className="w-5 h-5 text-green-500" />
            ...
            <p className="text-sm text-gray-500">{t("programROI")}</p>
          </div>
          <div className="text-center p-4 bg-gray-50 rounded-2xl">
            <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <p className="text-sm text-gray-500">{t("churnRate")}</p>
          </div>
        </div>
      </div>
    </div>
