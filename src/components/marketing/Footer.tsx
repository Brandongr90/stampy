...
export function Footer() {
  return (
    <footer className="bg-almost-black text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 max-w-sm mb-6">
              La plataforma mas simple para crear tarjetas de lealtad digitales que funcionan con Apple Wallet y Google Wallet.
            </p>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} Stampy. Todos los derechos reservados.
          </p>
          <p className="text-gray-400 text-sm">
