...
export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div
        className="blob-mint -bottom-32 -left-32"
        ...
        <div className="grid lg:grid-cols-[60%_40%] gap-12 items-center">
          ...
          >
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-display font-extrabold text-almost-black leading-tight mb-6">
              Tarjetas de Lealtad{" "}
              <span className="text-mint-600">Digitales</span> en Minutos
            </h1>
            <p className="text-lg sm:text-xl text-charcoal mb-8 max-w-xl mx-auto lg:mx-0">
              Crea programas de lealtad que funcionan con Apple Wallet y Google
              Wallet. Sin apps, sin complicaciones.
            </p>
                    ...
                    <div className="bg-gradient-to-br from-mint-400 to-mint-600 rounded-2xl p-6 text-white shadow-medium">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-xs text-white/70">
                          150 puntos para tu proximo cafe gratis
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="mt-6">
                      ...
                      <div className="space-y-3">
                        {[
                          {
                            action: "+50 puntos",
                            desc: "Compra en tienda",
                            time: "Hoy",
                          },
                          {
                            action: "+25 puntos",
                            desc: "Referido exitoso",
                            time: "Ayer",
                          },
                          {
                            action: "-500 puntos",
                            desc: "Cafe gratis canjeado",
                            time: "3 dias",
                          },
                        ].map((item, i) => (
                          <div
